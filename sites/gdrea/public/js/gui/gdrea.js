...
; (function ($, window, undefined) {
    ...
    fear.create('FearCore', function(GUI) {
        console.log('GUI at module level = ', GUI);
            ...
            return {
                ...
                init: function () {
                    return new Promise((resolve) => {
                        const isMobile = GUI.Event.isMobile();
        ...
        const createModalManager = () => {
            ...
            return {
                 ...
                 */
                bindEvents: function () {
                    return GUI.Event.on($modalBox.find('.close')[0], 'click', (e) => {
                        e.prEventDefault();
                        return this.close();
                    });
                },
        ...
        const createMobileMenu = () => {
            return {
                ...
                init: function () {
                    ...
                    return Promise.all([
                        GUI.Event.on($hamburger[0], 'click', toggleMenu),
                        ...$menuItems.map(item => GUI.Event.on(item, 'click', closeMenu))
                    ]);
                }
            };
        };
        ...
        return {
            load: (sb) => {
                console.log('sandbox at load level', sb);
    ...
    fear.create('FearRouter', function(GUI) {
        ...
        const createRouter = () => {
            ...
            return {
                ...
                init: function () {
                    ...
                    return Promise.all([
                        GUI.Event.on(window, 'hashchange', () => this.route()),
                        GUI.Event.on(window, 'popstate', () => this.route())
                    ])
                        .then(() => {
                    ...
                    return new Promise((resolve) => {
                        ...
                        $container.animateAsync({ opacity: 0 }, 200)
                            ...
                            .then(() => {
                                ...
                                GUI.Event.fire(GUI.broker, 'route:rendered', source);
                                resolve(true);
                            })
                            .catch(() => {
        ...
        return {
            load: (sb) => { 
                console.log('avail sandbox in FEarRouter = ', sb);
            ...
            return {
                ...
                bindLocationLinks: function () {
                    ...
                    $buttons.each((index, button) => {
                        const promise = GUI.Event.on(button, 'click', (e) => {
                            e.prEventDefault();
                ...
                initCursor: function () {
                    return new Promise((resolve) => {
                        ...
                        Promise.all([
                            GUI.Event.on(window, 'mousemove', updateCursor),
                            GUI.Event.on(document.body, 'mouseenter', addHover, {
                                selector: 'a, .fear_topbar .trigger, .cursor-pointer'
                            }),
                            GUI.Event.on(document.body, 'mouseleave', removeHover, {
                                selector: 'a, .fear_topbar .trigger, .cursor-pointer'
                            })
                        ])
                            .then(() => {
                ...
                initContactForm: function () {
                    ...
                    return GUI.Event.on($submitBtn[0], 'click', (e) => {
                        e.prEventDefault();
            ...
            load: function (options) {
                ...
                return Promise.all(
                    $buttons.map((index, button) => {
                        return GUI.Event.on(button, 'click', (e) => {
                            const $element = GUI.$(e.target);
