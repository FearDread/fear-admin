...
export default function CartPage() {
  ...
  // currentUser isn't used yet in this view, but kept wired up for the
  // upcoming "logged in as ___" treatment.
  ...
  const [discountMsg, setDiscountMsg] = useState<StatusMessage | null>(null);
  const [shippingMsg, setShippingMsg] = useState<StatusMessage | null>(null);
  ...
  const handleApplyDiscount = () => {
    ...
    setTimeout(() => {
      const discountPercentage = VALID_DISCOUNT_CODES[discountCode.toUpperCase()];
      ...
      if (discountPercentage) {
        ...
        setDiscountMsg({
          type: 'success',
          text: `Code applied — you saved $${discountAmount.toFixed(2)}!`,
        });
      } else {
  ...
  const handleEstimateShipping = () => {
    ...
    const shippingCost = country === 'United States' ? 10.0 : 25.0;
    dispatch(setShipping(shippingCost));
    setShippingMsg({
      type: 'success',
      text: `Estimated shipping: $${shippingCost.toFixed(2)}`,
    });
  };
        ...
        <div style={{ background: '#111111', borderBottom: '1px solid #222222', padding: '1rem 0' }}>
          <div className="efear-container">
            <nav className="ct-breadcrumb">
              ...
              <Link href="/shop" className="ct-bc-link">Shop</Link>
              <span className="ct-bc-sep">›</span>
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        <div style={{
                          ...
                          {/* eslint-disable-next-line @next/next/no-img-element -- TODO: swap for next/image once product image domains are configured */}
                          <img
