...
// Hoisted to module scope: defining this inside the component body gave it
// a brand-new function identity every render, so React treated it as a
// different component type each time and remounted it instead of just
// re-rendering — the same "recreated on every render" class of bug as the
// selector issue in ProductCard.
