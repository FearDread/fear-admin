...
export const POLICIES: Record<PolicySlug, PolicyConfig> = {
    ...
    terms: {
        ...
        related: [
            ...
            { label: 'Shipping Policy', href: '/shipping', icon: '🚚' },
        ],
        ...
        sections: [
            ...
            },
            {
                id: 'cookies', num: 'Section 05', title: 'Cookies', blocks: [
                    ...
                    { type: 'p', text: <>Most browsers automatically accept Cookies by default, but you can choose to set your browser to remove or reject Cookies through your browser controls. See our{' '}<Link href="/cookies" style={{ color: 'var(--accent)' }}>Cookie Policy</Link> for details on the specific cookies we use. Please keep in mind that removing or blocking Cookies can negatively impact your user experience and may cause some of the Services, including certain features and general functionality, to work incorrectly or no longer be available.</> },
                ]
            },
            {
        ...
        sections: [
            {
                id: 'policy', num: 'Section 01', title: 'Return / Refund Policy', accentKey: 'red', blocks: [
                    ...
                    { type: 'p', text: `If your return is accepted, we'll send you a return shipping label, as well as instructions on how and where to send your package. Please note that if your country of residence is not United States, shipping your goods may take longer than expected — see our{' '}` },
                    { type: 'p', text: <>You can always contact us for any return questions at <a href={`mailto:${EMAIL}`}>{EMAIL}</a>. For carrier timelines, see our <Link href="/shipping" style={{ color: 'var(--accent)' }}>Shipping Policy</Link>.</> },
                ]
            },
            {
    ...
    cookies: {
        ...
        intro: {
            id: 'intro',
            blocks: [
                { type: 'p', text: <>This Cookie Policy explains what cookies are, how FEAR Inc. uses them on efear.store, and the choices you have around them. It should be read alongside our{' '}<Link href="/privacy" style={{ color: 'var(--accent)' }}>Privacy Policy</Link>.</> },
            ],
        },
        nav: [
