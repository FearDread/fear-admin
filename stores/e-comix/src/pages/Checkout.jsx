        ...
        <ul class="d-flex align-items-center">
            ...
            <ul class="dropdown-menu shadow cart-dropdown-ne p-4" >
                ...
                <li>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="checkout.html#" class="products-sm-pic">
                            <div class="imo-caty">
                                <img src="images/blog2.png" alt="bn"/>
                            </div>
                        </a>
                        <div class="cart-ps-details">
                            <a href="checkout.html#" class="titel-crt-products">
                            Birthday Card
                            </a>
                            <h6> $12.52 </h6>
                        </div>
                        <a href="checkout.html#" class="close-crt"> <i class="fas fa-close"></i> </a>
                    </div>
                    </div>
                    <div class="comon-cart-ps">
                    <div class="d-flex align-items-center justify-content-between">
...
<footer class="float-start w-100 position-relative">
    ...
    <div class="fuyr-divu float-start">  
        ...
        <div class="container">
            ...
            <div class="col">
              <div class="items-footer-div w-100">
                  ...
                  <ul class="mt-5">
                    ...
                    <li>
                      <a href="checkout.html#" class="d-flex align-items-center w-100">
          ...
          <hr/>
          <a href="checkout.html#" class="text-center mx-auto my-5 d-table">
            <img alt="logo" src="images/foter-logo.png"/>
          </a>
          <ul class="solico my-5 d-block">
            <li class="d-flex justify-content-center align-items-center">
              <a href="checkout.html#" class="btn btn-socla">
          ...
          <div class="coptext mt-5 d-block">
             <ul class="d-lg-flex justify-content-center align-items-center">
              ...
              <li class="mx-lg-5">
                <a href="checkout.html#" class="text-white">  Terms & Conditions </a>
              </li>
              <li>
                <a href="checkout.html#" class="text-white">  Privacy Policy </a>
              </li>
             </ul>
          </div>
        </div>
    ...
    <div class="offcanvas-body px-5">
      <div class="head-contact d-none d-lg-block mt-3">
          ...
          <ul class="side-media d-flex align-items-center mt-5">
             ...
             <li> <a href="checkout.html#"> <i class="fab fa-google-plus-g"></i> </a> </li>
