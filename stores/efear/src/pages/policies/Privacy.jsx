            ...
            <section className="py-3 border-bottom d-none d-md-flex">
                <div className="container">
                    <div className="page-breadcrumb d-flex align-items-center">
                        <h3 className="breadcrumb-title pe-3">Privacy Policy</h3>
                            ...
                            <div className="blog-right-sidebar p-3">
                                <div className="card card-body shadow-none bg-transparent">
                                    <div className="card-body p-0">
                                        ...
                                        <p>This Privacy Policy describes how FEAR Inc. (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from e-fear.vercel.app (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>

                                        <p className="mb-4">Please read this Privacy Policy carefully. By using and accessing any of the Services, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services.</p>

                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Changes to This Privacy Policy</h4>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">How We Collect and Use Your Personal Information</h4>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">What Personal Information We Collect</h4>
                                            ...
                                            <h5 className="mt-4 mb-3">Information We Collect Directly from You</h5>
                                            ...
                                            <h5 className="mt-4 mb-3">Information We Collect through Cookies</h5>
                                            ...
                                            <h5 className="mt-4 mb-3">Information We Obtain from Third Parties</h5>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">How We Use Your Personal Information</h4>

                                            <h5 className="mt-3 mb-2">Providing Products and Services</h5>
                                            <p>We use your personal information to provide you with the Services in order to perform our contract with you, including to process your payments, fulfill your orders, to send notifications to you related to your account, purchases, returns, exchanges or other transactions, to create, maintain and otherwise manage your account, to arrange for shipping, facilitate any returns and exchanges and to enable you to post reviews.</p>

                                            <h5 className="mt-3 mb-2">Marketing and Advertising</h5>
                                            ...
                                            <h5 className="mt-3 mb-2">Security and Fraud Prevention</h5>
                                            ...
                                            <h5 className="mt-3 mb-2">Communicating with You</h5>
                                            <p>We use your personal information to provide you with customer support and improve our Services. This is in our legitimate interests in order to be responsive to you, to provide effective services to you, and to maintain our business relationship with you.</p>
                                        </div>

                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Cookies</h4>
                                            <p>Like many websites, we use Cookies on our Site. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services. We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</p>
                                            <p>Most browsers automatically accept Cookies by default, but you can choose to set your browser to remove or reject Cookies through your browser controls. Please keep in mind that removing or blocking Cookies can negatively impact your user experience and may cause some of the Services, including certain features and general functionality, to work incorrectly or no longer be available.</p>
                                        </div>

                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">How We Disclose Personal Information</h4>
                                            ...
                                            <ul>
                                                ...
                                                <li>In connection with a business transaction such as a merger or bankruptcy, to comply with any applicable legal obligations, to enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others</li>
                                            </ul>

                                            <h5 className="mt-4 mb-3">Categories of Personal Information Disclosed</h5>
                                            <p>We have, in the past 12 months, disclosed the following categories of personal information:</p>
                                            <ul>
                                            ...
                                            <p className="mb-2"><strong>Categories of Recipients:</strong></p>
                                            <ul>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">User Generated Content</h4>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Third Party Websites and Links</h4>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Children's Data</h4>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Security and Retention of Your Information</h4>
                                        ...
                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Your Rights and Choices</h4>
                                            ...
                                            <p>We will not discriminate against you for exercising any of these rights. We may need to collect information from you to verify your identity, such as your email address or account information, before providing a substantive response to the request.</p>
                                        </div>

                                        <div className="terms-section mb-4">
                                            <h4 className="text-uppercase mb-3">Contact Information</h4>
                                            <p>If you have any questions about this Privacy Policy or our privacy practices, please contact us at:</p>
                                            <p className="mb-2"><strong>FEAR Inc.</strong></p>
                                            <p className="mb-2">Email: <a href="mailto:fear.dread@underworld.dog" className="text-white">fear.dread@underworld.dog</a></p>
                                            <p>Website: <a href="https://e-fear.vercel.app" className="text-white">e-fear.vercel.app</a></p>
                                        </div>

                                        <div className="d-flex align-items-center gap-2 py-4 border-top">
                                            <p className="mb-0 text-muted"><small>This Privacy Policy was last updated on January 2026</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-12 col-lg-3">
                            <div className="blog-left-sidebar p-3">
                                <div className="blog-categories mb-3">
                                    <h5 className="mb-4">Quick Navigation</h5>
                                    <div className="list-group list-group-flush">
                                        <a href="#collection" className="list-group-item bg-transparent"><i className='bx bx-chevron-right me-1'></i> Information Collection</a>
                                        <a href="#usage" className="list-group-item bg-transparent"><i className='bx bx-chevron-right me-1'></i> How We Use Data</a>
                                        <a href="#cookies" className="list-group-item bg-transparent"><i className='bx bx-chevron-right me-1'></i> Cookies</a>
                                        <a href="#disclosure" className="list-group-item bg-transparent"><i className='bx bx-chevron-right me-1'></i> Information Disclosure</a>
                                        <a href="#rights" className="list-group-item bg-transparent"><i className='bx bx-chevron-right me-1'></i> Your Rights</a>
                                        <a href="#contact" className="list-group-item bg-transparent"><i className='bx bx-chevron-right me-1'></i> Contact Us</a>
                                    </div>
                                </div>

                                <div className="blog-categories mb-3">
                                    <h5 className="mb-4">Related Policies</h5>
                                    <div className="list-group list-group-flush">
                                        <a href="javascript:;" className="list-group-item bg-transparent"><i className='bx bx-file me-1'></i> Terms of Service</a>
                                        <a href="javascript:;" className="list-group-item bg-transparent"><i className='bx bx-file me-1'></i> Return Policy</a>
                                        <a href="javascript:;" className="list-group-item bg-transparent"><i className='bx bx-file me-1'></i> Cookie Policy</a>
                                        <a href="javascript:;" className="list-group-item bg-transparent"><i className='bx bx-file me-1'></i> Data Processing Agreement</a>
                                    </div>
                                </div>
