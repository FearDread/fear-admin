// policyStyles.js — shared design tokens + styles for Privacy, Terms, Returns
...
.pol-hero-title span { -webkit-text-stroke: 0; }
.pol-hero-meta {
...
.pol-meta-bar {
    ...
    border-left: 3px solid var(--accent, ${T.red});
...
.pol-section-sub {
    ...
    color: ${T.textHi}; margin: 1.5rem 0 .65rem;
    padding-left: .65rem;
    border-left: 2px solid ${T.border};
}
.pol-body {
    font-size: .88rem; color: ${T.textMid}; line-height: 1.8;
    margin: 0 0 .85rem;
}
...
.pol-list {
    padding-left: 0; margin: 0 0 .85rem; list-style: none;
}
.pol-list li {
    font-size: .88rem; color: ${T.textMid}; line-height: 1.75;
...
.pol-list li::before {
    ...
    font-size: .5rem; color: var(--accent, ${T.red}); line-height: 2.2;
}
...
.pol-highlight p {
    font-family: 'Space Mono', monospace;
    font-size: .75rem; color: ${T.textMid}; line-height: 1.65; margin: 0;
}
...
.pol-contact-box {
    ...
    padding: 1.25rem;
    background: ${T.dark2}; border: 1px solid ${T.border};
    border-top: 2px solid var(--accent, ${T.red});
    margin-top: 1rem;
...
.pol-contact-label {
    ...
    color: ${T.textDim}; display: block; margin-bottom: .25rem;
}
.pol-contact-val {
    font-family: 'Space Mono', monospace;
    font-size: .78rem; color: ${T.textHi};
}
...
.pol-cta-card-title {
    font-family: 'Anton','Impact',sans-serif;
    font-size: .85rem; text-transform: uppercase; color: #fff; margin: 0 0 .5rem;
}
.pol-cta-card-body {
    font-family: 'Space Mono', monospace;
    font-size: .65rem; color: ${T.textDim}; line-height: 1.6; margin: 0 0 1rem;
}
.pol-cta-btn {
    display: flex; align-items: center; justify-content: center; gap: .5rem;
    width: 100%; padding: .65rem;
    background: var(--sb-accent, ${T.red}); border: none; color: #fff;
...
.pol-animated-border {
    ...
    animation: polGrad 4s linear infinite;
}
