...
/* ── Single column ── */
const Column = ({ title, products, loading, accent, count, index }) => (
  <div
    className="bs-col"
    style={{
      '--col-accent': accent,
  ...
  >
    ...
    {loading ? (
      ...
      <div className="bs-empty">
        <div className="bs-empty-icon"><i className="bx bx-box" /></div>
      ...
      <div className="bs-container">
        ...
        <div className="bs-header">
          <div className="bs-header-left">
            ...
            <h2 className="bs-title">Best <span>Selling</span></h2>
          </div>
        ...
        {error && (
          <div className="bs-error">
            ...
            <div>
              ...
              <p className="bs-error-body">
                {typeof error === 'string' ? error : 'Something went wrong. Try refreshing.'}
              </p>
            </div>
          </div>
        )}
