...
const CATEGORIES = [
  { id: "essential", label: "Essential", desc: "Required for the site to function", locked: true },
...
export const CookieBanner = ({ onAccept, onReject }) => {
  ...
  const acceptAll = () => {
    onAccept({ essential: true, analytics: true, marketing: true, preferences: true });
  };
    ...
    <div className="cookie-backdrop">
      <div className="cookie-banner">
        ...
        <div className="cookie-actions">
          ...
          <button className="btn-reject" onClick={onReject}>Reject all</button>
          {!showCustom
            ? <button className="btn-custom" onClick={() => setShowCustom(true)}>Customise</button>
            : <button className="btn-custom" onClick={saveCustom}>Save preferences</button>
          }
        </div>
      </div>
    </div>
