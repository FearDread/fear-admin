...
const FAQ = () => {
  ...
  const expandAll = () => {
    setOpenItems(faqCategories.flatMap(cat => cat.faqs.map(faq => faq.id)));
  };
        ...
        <div className="faq-container">
          ...
          <div className="faq-quicklinks">
            ...
            <div className="faq-quicklinks-grid">
              {[
                { to: '/shop',              icon: 'bx-shopping-bag', label: 'Shop Now'      },
                { to: '/account/orders',    icon: 'bx-package',      label: 'Track Order'   },
                { to: '/account/dashboard', icon: 'bx-refresh',      label: 'Returns'       },
                { to: '/account/shipping',  icon: 'bx-car',          label: 'Shipping Info' },
              ].map(({ to, icon, label }) => (
                <Link key={to} to={to} className="faq-quicklink-card">
