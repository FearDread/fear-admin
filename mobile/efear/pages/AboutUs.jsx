  ...
  <section style={{ position: 'relative', background: T.dark0, overflow: 'hidden', padding: '6rem 0 5rem' }}>
    ...
    <div className="container" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '2rem' }}>
        <Link to="/" style={{ fontFamily: "'Space Mono',monospace", fontSize: '.7rem', letterSpacing: '.15em', textTransform: 'uppercase', color: T.textDim, textDecoration: 'none' }}>Home</Link>
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        <Link to="/shop" className="btn-about-primary">Shop Now</Link>
    ...
    <section style={{ padding: '6rem 0' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: '1.5rem' }}>
          {offers.map(o => (
            <div key={o.title} className="offer-tile" style={{ '--o-accent': o.accent }}>
              ...
              <div className="offer-tile-footer">
                ...
                <Link to={o.link} className="offer-tile-link">Shop {o.title} →</Link>
              </div>
            </div>
          ))}
        </div>
...
const OurPromise = () => {
  ...
  return (
    <section style={{ padding: '6rem 0', background: T.dark0, position: 'relative', overflow: 'hidden' }}>
      ...
      <style>{`@media(max-width:900px){ .promise-grid { grid-template-columns: 1fr !important; gap: 3rem !important; } }`}</style>
    </section>
  );
};
  ...
  return (
    <section style={{ padding: '6rem 0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1.5rem' }}>
          {diffs.map(d => (
            ...
            >
              ...
              <div style={{
                position: 'absolute', bottom: 0, left: 0, right: 0,
                height: '3px', background: d.accent,
                transform: 'scaleX(0)', transformOrigin: 'left',
                transition: 'transform .35s',
              }} className="diff-underline" />
            </div>
          ))}
        </div>
      </div>
      <style>{`
        ...
        .diff-card:hover .diff-underline { transform: scaleX(1) !important; }
  ...
  <section style={{ padding: '6rem 0', background: T.dark0 }}>
    <div className="container">
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
        ...
        {/* stacked disclaimer / quote cards */}
        ...
        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '1.5rem' }}>
          {brands.map(b => (
            <div key={b} style={{
              ...
              border: `1px solid ${T.border}`,
              fontFamily: "'Anton','Impact',sans-serif",
              fontSize: '1rem', letterSpacing: '.05em', textTransform: 'uppercase',
              color: T.textDim,
