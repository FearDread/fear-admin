...
module.exports = AgentWebInterface = (() => {
  // Private constants
   ...
   * Constructor
   */
  const AgentWebInterface = function(fearInstance) {
    if (!fearInstance) {
  ...
  AgentWebInterface.prototype = {
    constructor: AgentWebInterface,
 ...
 * Factory function
 */
exports.createAgentInterface = (fearInstance) => {
  return new AgentWebInterface(fearInstance);
};