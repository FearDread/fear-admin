...
export const BLOG_SECTIONS_REQUEST = "BLOG_SECTIONS_REQUEST";
export const BLOG_SECTIONS_SUCCESS = "BLOG_SECTIONS_SUCCESS";
export const BLOG_SECTIONS_FAIL = "BLOG_SECTIONS_FAIL";