      ...
      <div className="discount-alert bg-dark-1 d-none d-lg-block">
        <div className="alert alert-dismissible fade show shadow-none rounded-0 mb-0 border-bottom">
          <div className="d-lg-flex align-items-center gap-2 justify-content-center">
            <p className="mb-0 text-white">Get Up to <strong>40% OFF</strong> New-Season Styles</p>	<a href="javascript:;" className="bg-dark text-white px-1 font-13 cursor-pointer">Men</a>
            <a href="javascript:;" className="bg-dark text-white px-1 font-13 cursor-pointer">Women</a>
