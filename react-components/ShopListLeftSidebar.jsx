...
function ShopListLeftSidebar() {
  return (
        ...
        <section className="py-3 border-bottom d-none d-md-flex">
          <div className="container">
            <div className="page-breadcrumb d-flex align-items-center">
              <h3 className="breadcrumb-title pe-3">Shop List Left Sidebar</h3>
    ...
    <div className="col-12 col-xl-9">
      <div className="product-wrapper">
        <div className="toolbox d-flex align-items-center mb-3 gap-2">
          ...
          <div>	<a href="shop-grid-left-sidebar.html" className="btn btn-light rounded-0"><i className='bx bxs-grid me-0'></i></a>
        </div>
        <div>	<a href="shop-list-left-sidebar.html" className="btn btn-white rounded-0"><i className='bx bx-list-ul me-0'></i></a>
      </div>
    </div>
      ...
      <div className="col-md-8">
        ...
        <div className="product-action mt-2">
          <div className="d-flex gap-2">
            <a href="javascript:;" className="btn btn-white btn-ecomm"> <i className="bx bxs-cart-add"></i>Add to Cart</a> <a href="javascript:;" className="btn btn-light btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i className="bx bx-zoom-in"></i>Quick View</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="row g-0">
      <div className="col-md-4">
        <img src="assets/images/products/02.png" className="img-fluid" alt="..." />
      </div>
      <div className="col-md-8">
        <div className="card-body">
          <div className="product-info">
    ...
    <div className="row g-0">
      <div className="col-md-4">
        <img src="assets/images/products/03.png" className="img-fluid" alt="..." />
      </div>
      <div className="col-md-8">
        <div className="card-body">
          <div className="product-info">
    ...
    <div className="row g-0">
      <div className="col-md-4">
        <img src="assets/images/products/04.png" className="img-fluid" alt="..." />
      </div>
      <div className="col-md-8">
        <div className="card-body">
          <div className="product-info">
    ...
    <div className="row g-0">
      <div className="col-md-4">
        <img src="assets/images/products/05.png" className="img-fluid" alt="..." />
      </div>
      <div className="col-md-8">
        <div className="card-body">
          <div className="product-info">
    ...
    <div className="row g-0">
      <div className="col-md-4">
        <img src="assets/images/products/06.png" className="img-fluid" alt="..." />
      </div>
      <div className="col-md-8">
        <div className="card-body">
          <div className="product-info">
    ...
    <div className="row g-0">
      <div className="col-md-4">
        <img src="assets/images/products/07.png" className="img-fluid" alt="..." />
      </div>
      <div className="col-md-8">
        <div className="card-body">
          <div className="product-info">
...
export default ShopListLeftSidebar;
