                ...
                <ul class="dropdown-menu shadow cart-dropdown-ne p-4" >
                  ...
                  <li>
                     <div class="comon-cart-ps">
                        <div class="d-flex align-items-center justify-content-between">
                           <a href="blog.html#" class="products-sm-pic">
                              <div class="imo-caty">
                                  <img src="images/blog2.png" alt="bn"/>
                              </div>
                           </a>
                           <div class="cart-ps-details">
                              <a href="blog.html#" class="titel-crt-products">
                               Birthday Card
                              </a>
                              <h6> $12.52 </h6>
                           </div>
                           <a href="blog.html#" class="close-crt"> <i class="fas fa-close"></i> </a>
                        </div>
                     </div>
                     <div class="comon-cart-ps">
                      <div class="d-flex align-items-center justify-content-between">
...
<main class="float-start w-100 total-body home-body mt-0">
    ...
    <section class="blogs-info-div d-inline-block w-100">
        <div class="container">
            <div class="row g-5">
               <div class="col-lg-8">
                   <a href="blog-details.html" class="comon-blogs-list-items mb-5">
                         <figure>
                           <img src="images/360_F_117750219_dEXN5T0ENx62pMVgADlHKDSy334VpKPJ.jpg" alt="pnm"/>
                           <figcaption>
                               10<b class="d-block">Jan</b>
                           </figcaption>
                         </figure>
                         <div class="content-post">
                           <h6> <i class="fas fa-tags"></i> Webdesign</h6>
               ...
               <div class="col-lg-4">
                   ...
                   <div class="comon-sec-blogs-inf-right">
                       <h5 class="subheding"> Categories </h5>
                       ...
                       <ul class="mt-4">
                           ...
                           <li>
                               <a href="blog.html#">  <span> <i class="fas fa-arrow-right"></i> </span>
                                In tempor  </a>
                   ...
                   <div class="comon-sec-blogs-inf-right">
                       <a href="blog.html#" class="como-list blogs-ioj d-flex align-items-center">
                           <div class="jou-div">
                               <img alt="ju" src="images/blog3.png"/>
                           </div>
                           <div class="textry">
                               <h5> Maecenas cursus diam vel mi posuere scelerisque </h5>
                               <p class="mt-2"> Jan 01, 2023 </p>
                           </div>
                       </a>
                   </div>
                   ...
                   <div class="comon-sec-blogs-inf-right tags02">
                       <h5 class="subheding"> Tags </h5>
                       <span class="line-ani"></span>
                       <ul class="mt-4">
                           <li>
                   ...
                   <div class="comon-sec-blogs-inf-right">
                       <h5 class="subheding"> Archives </h5>
                       <span class="line-ani"></span>
                       <ul class="mt-4">
                           <li>
                               <a href="blog.html#"> <span> <i class="fas fa-calendar-week"></i> </span> January 2022  </a>
                               
                           </li>
                           <li>
                               <a href="blog.html#"> <span> <i class="fas fa-calendar-week"></i> </span> February 2022  </a>
                               
                           </li>
                           <li>
                               <a href="blog.html#"> <span> <i class="fas fa-calendar-week"></i> </span> March 2022  </a>
                               
                           </li>
                           <li>
                               <a href="blog.html#"> <span> <i class="fas fa-calendar-week"></i> </span> April 2022   </a>
           ...
           <div class="col-lg-8">
            <h6 class="text-center text-lg-start sub-heading" data-aos="fade-down"> You may unsubscribe at any moment </h6>
             <h2 class="text-center text-lg-start page-haeding mt-4" data-aos="fade-up">  Get your Need on by subcribing 
              ...
              <a href="blog.html#" class="btn comon-button mx-auto ms-lg-0 mt-5 d-table d-inline-lg-block" data-aos="fade-up">  <span> <i class="fas fa-arrow-right"></i> See All Post </span> </a>
           </div>
        </div>
...
<footer class="float-start w-100 position-relative">
  ...
  <div class="fuyr-divu float-start">  
      ...
      <div class="container">
        ...
        <hr/>
        <a href="blog.html#" class="text-center mx-auto my-5 d-table">
          <img alt="logo" src="images/foter-logo.png"/>
        </a>
        <ul class="solico my-5 d-block">
          <li class="d-flex justify-content-center align-items-center">
            <a href="blog.html#" class="btn btn-socla">
        ...
        <div class="coptext mt-5 d-block">
           <ul class="d-lg-flex justify-content-center align-items-center">
            ...
            <li class="mx-lg-5">
              <a href="blog.html#" class="text-white">  Terms & Conditions </a>
            </li>
            <li>
              <a href="blog.html#" class="text-white">  Privacy Policy </a>
            </li>
           </ul>
        </div>
      </div>
