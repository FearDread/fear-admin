...
export const ADMIN_CATEGORY_REQUEST ="ALL_CATEGORY_REQUEST"
export const ADMIN_CATEGORY_SUCCESS = "ALL_CATEGORY_SUCCESS";
export const ADMIN_CATEGORY_FAIL = "ALL_CATEGORY_FAIL";
